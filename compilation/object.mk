...
MODULE_INCLUDE_FLAGS = -I${MODULE_SRC_INC_PATH} -I${MODULE_SRC_PATH} $(MODULE_DEPS_MODULES:%=-I${OUTPUTS_DIR}/%/include)
...
SUBMODULECHILD_INCLUDE_FLAGS = -I${SUBMODULECHILD_SRC_INC_PATH} -I${SUMODULECHILD_SRC_PATH} $(SUBMODULECHILD_DEPS_MODULES:%=-I${OUTPUTS_DIR}/%/include)
